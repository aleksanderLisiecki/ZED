...
gold.btc %>%
  ggplot( aes(x = Date) ) +
  geom_line( aes(y = USD.gold), color = 'yellow' ) +
  ...
  theme_bw() + 
  theme(
    axis.title.y = element_text(color = 'yellow', size=13),
    axis.title.y.right = element_text(color = 'orange', size=13),
    axis.text.y = element_text(color = 'yellow', size=13),
...
gold.SP %>%
  ggplot( aes(x = Date) ) +
  geom_line( aes(y = USD), color = 'orange' ) +
  ...
  theme(
    ...
    axis.text.y = element_text(color = 'orange', size=13),
